...
#' @aliases serialCorrelationTest.default serialCorrelationTest.lm
#' @rawRd \alias{serial correlation test}
#' @rawRd \alias{serial correlation}
#' @description
...
#' and background material are available in \code{vignette("extended-function-details", package = "EnvStats")}, section \code{serialCorrelationTest}.
#' @rawRd
#' \value{
