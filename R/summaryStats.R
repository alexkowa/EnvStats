#' Summary Statistics
#' @aliases summaryStats.formula summaryStats.default summaryStats.factor
#' @aliases summaryStats.logical summaryStats.character summaryStats.data.frame
#' @aliases summaryStats.matrix summaryStats.list
#' @description
